...
import { AuthenticatedRegisterRedirect } from "@/components/authenticated-register-redirect";
                ...
                <header className="space-y-5">
                  <div className="space-y-2">
                    <h1 className="text-[clamp(2rem,5vw,2.75rem)] font-semibold tracking-[-0.055em] text-[var(--panel-ink)]">
                      {gt("Start your workspace")}
                    </h1>
                    <p className="max-w-md text-sm leading-6 text-[var(--ink-muted)] sm:text-[0.95rem]">
                      {gt("A few details and you're straight into organization onboarding.")}
                    </p>
                  </div>
                </header>
